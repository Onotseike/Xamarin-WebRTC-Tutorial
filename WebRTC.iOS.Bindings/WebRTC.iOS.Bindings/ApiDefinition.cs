...
namespace WebRTC.iOS.Bindings
{
    ...
    #region RTCDefaultVideoDecoderFactory
    ...
    interface RTCVideoCodecInfo : INSCoding
    {
        ...
        [Export("initWithName:")]
        IntPtr InitWithName(string name);
    ...
    interface RTCH264ProfileLevelId
    {
        ...
        IntPtr InitWithHexString(string hexString);

        // -(instancetype)initWithProfile:(RTCH264Profile)profile level:(RTCH264Level)level;
        [Export("initWithProfile:level:")]
        IntPtr InitWithProfile(RTCH264Profile profile, RTCH264Level level);
    }

    #endregion

    #region RTCVideoDecoderFactory
    ...
    interface RTCVideoFrame
    {
        ...
        IntPtr InitWithBuffer(RTCVideoFrameBuffer frameBuffer, RTCVideoRotation rotation, long timeStampNs);
    ...
    #region RTCAudioSessionDelegate
    ...
    interface RTCAudioSessionDelegate
    {
        ...
        void DisSetActive(RTCAudioSession audioSession, bool active);
    ...
    #region RTCVideoCapturerDelegate
    ...
    #region RTCDataChannelConfiguration
    ...
    #region RTCPeerConnectionDelegate
    ...
    interface RTCPeerConnection_Stats
    {
        ...
        void StatsForTrack([NullAllowed] RTCMediaStreamTrack mediaStreamTrack, RTCStatsOutputLevel statsOutputLevel, [NullAllowed] Action<NSArray<NSObject>> completionHandler);
    ...
    interface RTCRtpTransceiver
    {
        ...
        unsafe bool CurrentDirection(IntPtr currentDirectionOut);
